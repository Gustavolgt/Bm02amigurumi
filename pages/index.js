...
const Home = () => {
    ...
    const src = query.src
    const url = "https://app.monetizze.com.br/r/BPV1345008?src=bm02" + src
...
<section className="section separador3 has-text-centered">
        ...
        <section className="section has-text-centered has-background-roxo-claro">
          <div className="container">
            ...
            <br/>
            <br/>
            <a href="https://api.whatsapp.com/send?phone=554391914561&text=Oiiee,%20Gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20sobre%20o%20cuso"><i className="fab fa-whatsapp fa-6x"></i></a>
          </div>
        </section>
        <section className="p-4 has-background-black has-text-centered has-text-white">
          ...
          <img href="https://app.monetizze.com.br/r/BPV1345008?src=bm02" width="1" height="1"/>
        </section>
            </main>
        </>
    );
