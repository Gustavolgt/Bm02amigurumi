                ...
                <section className="section has-background-light-roxo">
                    <div className="container has-text-centered">
                        <p className="is-size-3-desktop is-size-5-mobile">
                            Jása imaginou começar seu <span className="is-roxo">Negocio proprio de Amigurumis</span> em seu proprio <br /> lar e <span className="is-roxo">sem precisar investir</span> em equipamentos caros?
                        </p>
                        <br />
                        <br />
                        <p className="is-size-3-desktop is-size-5-mobile">
